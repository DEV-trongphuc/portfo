                    ...
                    <div className="pt-8 space-y-6">
                      <div className="text-left">
                        ...
                        <h3 className="text-2xl font-black mt-4 text-transparent bg-clip-text bg-gradient-to-r from-white via-purple-100 to-amber-200 leading-tight">
                          Chiến dịch quảng cáo Nha khoa nổi bật
                        </h3>
                      </div>

                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        {/* Card 1: Brandson */}
                        <div className="bg-[#0f0b24] border border-purple-900/40 rounded-2xl p-6 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow min-h-[300px]">
                          <div>
                            <div className="flex flex-wrap gap-1.5 mb-3">
                              {['Dental', 'Google Search', 'FB Ads'].map((tag) => (
                                <span key={tag} className="text-[9px] font-black uppercase tracking-widest text-slate-400 bg-[#161033] px-2.5 py-1 rounded-full">
                                  {tag}
                                </span>
                              ))}
                            ...
                            <div className="flex items-center gap-3.5 mb-4 text-left">
                              <div className="w-10 h-10 rounded-xl overflow-hidden border border-purple-900/40 bg-[#0f0b24] shrink-0">
                                <img src={logoBrandson} alt="Brandson" className="w-full h-full object-cover" />
                              </div>
                              <div>
                                <h3 className="text-xl font-black text-white leading-tight">Cấy Ghép Nha Khoa Cơ Bản</h3>
                                <span className="text-[9px] text-purple-300 font-black uppercase tracking-wider block mt-0.5">Brandson Campaign</span>
                              </div>
                            </div>
                            ...
                            <div className="grid grid-cols-3 gap-2 bg-[#030014] border border-purple-900/30 rounded-2xl p-4 mb-4 text-left">
                              <div>
                                <span className="text-[8px] text-slate-400 uppercase font-black block tracking-widest mb-1">Impact</span>
                                <span className="text-[10px] font-black text-slate-200 leading-tight">Google/FB Ads</span>
                              </div>
                              <div className="border-l border-purple-900/40 pl-3">
                                <span className="text-[8px] text-slate-400 uppercase font-black block tracking-widest mb-1">Budget</span>
                                <span className="text-[10px] font-black text-slate-400 leading-tight">30,000,000đ</span>
                              </div>
                              <div className="border-l border-purple-900/40 pl-3">
                                <span className="text-[8px] text-slate-300 uppercase font-black block tracking-widest mb-1">Result</span>
                                <span className="text-xs font-black text-white leading-tight">80+ Leads</span>
                              </div>
                            </div>

                            <div className="border-t border-purple-900/30 pt-4 text-left">
                              <p className="text-slate-400 text-xs leading-relaxed font-light text-justify">
                                Chiến dịch tối ưu quảng cáo Google Search & Facebook Ads thu hút khách hàng có nhu cầu trồng răng Implant. Tối ưu landing page giúp tăng tỷ lệ chuyển đổi, đem về hơn 80+ leads chất lượng cao chỉ với ngân sách 30 triệu đồng.
                              </p>
                            </div>
                          </div>
                          <div className="pt-4 flex justify-end">
                            <a 
                              ...
                              target="_blank" 
                              rel="noreferrer"
                              className="px-4 py-2 bg-[#161033] hover:bg-purple-900/20 text-slate-200 font-bold text-xs rounded-lg transition-colors flex items-center gap-1.5 border border-purple-900/40"
                            >
                        ...
                        {/* Card 2: Nha khoa Flora */}
                        <div className="bg-[#0f0b24] border border-purple-900/40 rounded-2xl p-6 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow min-h-[300px]">
                          <div>
                            <div className="flex flex-wrap gap-1.5 mb-3">
                              {['Implant Event', 'FB Lead Ads', 'Conversion'].map((tag) => (
                                <span key={tag} className="text-[9px] font-black uppercase tracking-widest text-slate-400 bg-[#161033] px-2.5 py-1 rounded-full">
                                  {tag}
                                </span>
                              ))}
                            ...
                            <div className="flex items-center gap-3.5 mb-4 text-left">
                              <div className="w-10 h-10 rounded-xl overflow-hidden border border-purple-900/40 bg-[#0f0b24] shrink-0">
                                <img src={logoFlora} alt="Nha khoa Flora" className="w-full h-full object-cover" />
                              </div>
                              <div>
                                <h3 className="text-xl font-black text-white leading-tight">Ngày Hội Implant</h3>
                                <span className="text-[9px] text-purple-300 font-black uppercase tracking-wider block mt-0.5">Flora Clinic</span>
                              </div>
                            </div>
                            ...
                            <div className="grid grid-cols-3 gap-2 bg-[#030014] border border-purple-900/30 rounded-2xl p-4 mb-4 text-left">
                              <div>
                                <span className="text-[8px] text-slate-400 uppercase font-black block tracking-widest mb-1">Impact</span>
                                <span className="text-[10px] font-black text-slate-200 leading-tight">FB Lead Ads</span>
                              </div>
                              <div className="border-l border-purple-900/40 pl-3">
                                <span className="text-[8px] text-slate-400 uppercase font-black block tracking-widest mb-1">Budget</span>
                                <span className="text-[10px] font-black text-slate-400 leading-tight">20,000,000đ</span>
                              </div>
                              <div className="border-l border-purple-900/40 pl-3">
                                <span className="text-[8px] text-slate-300 uppercase font-black block tracking-widest mb-1">Result</span>
                                <span className="text-xs font-black text-white leading-tight">60+ Khách</span>
                              </div>
                            </div>

                            <div className="border-t border-purple-900/30 pt-4 text-left">
                              <p className="text-slate-400 text-xs leading-relaxed font-light text-justify">
                                Chiến dịch truyền thông và Lead Generation cho sự kiện Ngày Hội Implant của Nha khoa Flora. Tập trung tối ưu đối tượng trung niên tại TP.HCM, thu về hơn 60 khách hàng đăng ký tham dự trực tiếp với chi phí tối ưu.
                              </p>
                            </div>
                          </div>
                          <div className="pt-4 flex justify-end">
