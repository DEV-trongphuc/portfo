...
const BookSpotlight: React.FC = () => {
  ...
  return (
    <section className="py-40 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[600px] h-[600px] bg-blue-900/10 rounded-full blur-[120px] pointer-events-none"></div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-32">
            ...
            <div className="w-full lg:w-1/2 order-2 lg:order-1 text-center lg:text-left">
                 ...
                 <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    ...
                    <button className="px-10 py-5 border border-white/20 text-white font-bold uppercase text-xs tracking-[0.2em] rounded-full hover:bg-white/10 transition-all flex items-center gap-3">
            ...
            <div className="w-full lg:w-1/2 order-1 lg:order-2 flex justify-center relative perspective-1000 mt-12 lg:mt-0">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[500px] bg-gradient-to-tr from-gold-600/20 to-purple-600/20 rounded-full blur-[80px]"></div>
                ...
                >
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-black/60 backdrop-blur-sm border border-gold-500/50 text-gold-500 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">
                        Click to Read
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <span className="text-[10px] font-bold text-white">New Edition 2024</span>
                </motion.div>
                    ...
                    <div className="relative w-full h-full flex items-center justify-center flex-col pointer-events-none">
                        ...
                        >
                            ...
                            <motion.button 
                                ...
                                whileTap={{ scale: 0.9 }}
                                className="absolute -top-6 -right-6 md:-right-12 md:-top-4 p-3 bg-black/30 backdrop-blur-md border border-white/20 text-white/70 hover:text-white hover:bg-white/20 rounded-full transition-all z-[200] cursor-pointer"
                            >
                                <X size={20} />
                            </motion.button>
                                                    ...
                                                    <div className="w-full h-full bg-gradient-to-br from-[#0a0a0a] to-[#000] flex flex-col items-center justify-center p-8 text-center relative overflow-hidden">
                                                        ...
                                                        <div className="relative z-10 scale-90 md:scale-100">
                                                            ...
                                                            <div className="space-y-3 w-full max-w-[220px] mx-auto">
                                                                <button className="w-full py-4 bg-gold-500 text-black font-black uppercase text-xs tracking-[0.2em] rounded-xl hover:bg-white transition-all flex items-center justify-center gap-3 hover:scale-105 active:scale-95 duration-300 shadow-lg shadow-gold-500/20">
